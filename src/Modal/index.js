          ...
          return (
              <div className="my_modal_main">
                  ...
                  <div className="moadl_main" style={{width:this.state.width,
                      ...
                      {/*<div className="moadl_footer">
                       <button type="primary" onClick={this.closeModel} className="myBtn-normal">取消</button>
                       <div style={{width:"2%"}}></div>
                      button type="primary" onClick={this.closeModel} className="myBtn">
                      确定
                      </button>
                      </div>*/}
                  </div>
