        ...
        return (
            <div className="transfer_main">
                <div className="transfer_left">
                    <div className="transfer_left_title" >
                        <input type="search" className="transfer_search" placeholder="请输入关键字" onChange={this.leftChange} value={this.state.leftSeach}/>
                    </div>
                    <div className="transfer_left_main">
                        <ul>
                            {
                                this.state.leftList.map((item,index)=>{
                                    ...
                                    if(item.name.indexOf(this.state.leftSeach) !== -1){
                                        return (
                                            <li key={index}>
                                                <input className="transfer_checkbox" type="checkbox" title={item.name} required name="left" id={item.id}/>
                                                <div className="transfer_left_name" >{item.name}</div>
                                            </li>
                                        );
                                    }
                ...
                <div className="transfer_mid">
                    <div>
                        <div onClick={this.add.bind(this)}>添加</div>
                        <div onClick={this.reduce.bind(this)}>减少</div>
                    </div>
                </div>
                <div className="transfer_right">
                    <div className="transfer_right_title">
                        <input type="search" className="transfer_search" placeholder="请输入关键字" onChange={this.rightChange} value={this.state.rightSeach}/>
                    </div>
                    <div className="transfer_right_main">
                        <ul>
                            {
                                this.state.rightList.map((item,index)=>{
                                    ...
                                    if(item.name.indexOf(this.state.rightSeach) !== -1){
                                        return (
                                            <li key={index}>
                                                <input className="transfer_checkbox" type="checkbox" title={item.name} required name="right" id={item.id}/>
                                                <div className="transfer_right_name" >{item.name}</div>
                                            </li>
                                        );
                                    }
